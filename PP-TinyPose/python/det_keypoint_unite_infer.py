...
from extd import cal_ang, toLegal
...
def topdown_unite_predict_video(detector,
    ...
    while (1):
        ...
        # TODO pose_dict
        pose_list = keypoint_res["keypoint"][0][0]
        pose_dict = {
            "Nose": pose_list[0],
            "Left_Eye": pose_list[1],
            "Right_Eye": pose_list[2],
            "Left_Ear": pose_list[3],
            "Right_Ear": pose_list[4],
            "Left_Shoulder": pose_list[5],
            "Right_Shoulder": pose_list[6],
            "Left_Elbow": pose_list[7],
            "Right_Elbow": pose_list[8],
            "Left_Wrist": pose_list[9],
            "Right_Wrist": pose_list[10],
            "Left_Hip": pose_list[11],
            "Right_Hip": pose_list[12],
            "Left_Knee": pose_list[13],
            "Right_Knee": pose_list[14],
            "Left_Ankle": pose_list[15],
            "Right_Ankle": pose_list[16]
        }
        # print(pose_dict)
        angle_dict = {
            "Left_Shoulder_Elbow_Wrist": cal_ang(pose_dict["Left_Shoulder"], pose_dict["Left_Elbow"], pose_dict["Left_Wrist"]),
            "Right_Shoulder_Elbow_Wrist": cal_ang(pose_dict["Right_Shoulder"], pose_dict["Right_Elbow"], pose_dict["Right_Wrist"]),
            "Left_Elbow_Shoulder_Hip": cal_ang(pose_dict["Left_Elbow"], pose_dict["Left_Shoulder"], pose_dict["Left_Hip"]),
            "Right_Elbow_Shoulder_Hip": cal_ang(pose_dict["Right_Elbow"], pose_dict["Right_Shoulder"], pose_dict["Right_Hip"]),
            "Left_Shoulder_Hip_Knee": cal_ang(pose_dict["Left_Shoulder"], pose_dict["Left_Hip"], pose_dict["Left_Knee"]),
            "Right_Shoulder_Hip_Knee": cal_ang(pose_dict["Right_Shoulder"], pose_dict["Right_Hip"], pose_dict["Right_Knee"]),
        }
        send_data = "a{}b{}c{}d{}e{}f{}Z".format(
            toLegal(angle_dict["Left_Shoulder_Elbow_Wrist"]),
            toLegal(angle_dict["Left_Elbow_Shoulder_Hip"]),
            toLegal(angle_dict["Left_Shoulder_Elbow_Wrist"]),
            toLegal(angle_dict["Right_Shoulder_Hip_Knee"]),
            toLegal(angle_dict["Right_Elbow_Shoulder_Hip"]),
            toLegal(angle_dict["Right_Shoulder_Elbow_Wrist"])
        )
        print("------------- send data ----------------------")
        print(send_data)
        send_msg(send_data)
        ...
        writer.write(im)
        if 1 == 1:
            cv2.putText(im, f"fps: {1/(time.time() - start_time)}", (5, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 255), 2)
